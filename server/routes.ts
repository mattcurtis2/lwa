...
export function registerRoutes(app: Express): Server {
  ...
  (async () => {
    ...
    const defaultContent = [
      ...
      { key: "bakery_title", value: "Our Bakery", type: "text" },
      { key: "bakery_text", value: "Fresh bread and delicious pastries baked daily using traditional methods and the finest ingredients.", type: "text" },
      { key: "products_title", value: "Farm Products", type: "text" },
      { key: "products_text", value: "Fresh, seasonal vegetables and farm products grown with care using sustainable practices.", type: "text" },
    ];
