...
export default function SheepUpcomingLitters() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Upcoming sheep litters at Little Way Acres in Hudsonville, Michigan. Future lambs expected for families in Grand Rapids, Holland, Zeeland, Byron Center, and West Michigan area within 50 miles. Reserve your lambs now.');
    }
    ...
    script.setAttribute('data-page', 'sheep-upcoming-litters');
    script.textContent = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "CollectionPage",
      "name": "Upcoming Sheep Litters",
      "description": "Upcoming sheep litters in Hudsonville, Michigan area",
      "url": `${window.location.origin}/sheep/litters/upcoming`,
      "areaServed": [
