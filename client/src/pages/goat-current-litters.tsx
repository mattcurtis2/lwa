                        ...
                        <div className="grid grid-cols-1 gap-2">
                          {litter.kids.slice(0, 4).map((kid) => (
                            <div key={kid.id} className="flex items-center gap-3">
                              <div className={`w-9 h-9 rounded-full overflow-hidden ${kid.gender === 'female' ? 'bg-pink-50 border-pink-100' : 'bg-blue-50 border-blue-100'} border-2 flex-shrink-0`}>
                                {kid.profileImageUrl ? (
                                  <img 
                                  ...
                                  <div className="w-full h-full flex items-center justify-center">
                                    <span className={`text-sm ${kid.gender === 'female' ? 'text-pink-400' : 'text-blue-400'}`}>
                                      {kid.gender === 'female' ? '♀' : '♂'}
                                    </span>
                                  </div>
                                )}
