...
var useMemoryUploads = process.env.VERCEL === "1" || process.env.AWS_LAMBDA_FUNCTION_NAME !== void 0;
if (!useMemoryUploads) {
  fs3.ensureDirSync(uploadDir);
}
var storage2 = useMemoryUploads ? multer2.memoryStorage() : multer2.diskStorage({
